...
CREATE TABLE `vendita` (
  ...
  KEY `fk_vendita_dolci1_idx` (`id_dolce`),
  CONSTRAINT `fk_vendita_dolci1` FOREIGN KEY (`id_dolce`) REFERENCES `dolci` (`id_dolce`)
...
INSERT INTO `vendita` VALUES (1,1,'2021-04-12',3),(2,2,'2021-04-20',5),(3,3,'2021-04-19',10),(4,4,'2021-04-18',5),(5,5,'2021-04-15',50);
